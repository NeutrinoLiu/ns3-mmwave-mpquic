...
class MmWaveHelper : public Object
{
  public:
    MmWaveHelper();
    // MmWaveHelper(uint64_t, uint16_t);
    ...
    NetDeviceContainer InstallMcUeDevice(NodeContainer c, uint64_t imsi_base);
    NetDeviceContainer InstallInterRatHoCapableUeDevice(NodeContainer c);
    NetDeviceContainer InstallEnbDevice(NodeContainer c);
    NetDeviceContainer InstallLteEnbDevice(NodeContainer c, uint16_t r);
  ...
  private:
    ...
    Ptr<NetDevice> InstallSingleMcUeDevice(Ptr<Node> n, uint64_t imsi);
    Ptr<NetDevice> InstallSingleEnbDevice(Ptr<Node> n);
    Ptr<NetDevice> InstallSingleLteEnbDevice(Ptr<Node> n, uint16_t r);
